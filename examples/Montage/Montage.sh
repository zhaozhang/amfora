...
do
   src/amc.py queue "/home/zhaozhang/Montage/Montage_v3.3/bin/mProjectPP -X /tmp/amfora/rawdir/${file} /tmp/amfora/projdir/hdu0_${file} /tmp/amfora/template.hdr" 
done
src/amc.py execute
...
mAdd -p /tmp/amfora/corrdir /tmp/amfora/images.tbl /tmp/amfora/template.hdr /tmp/amfora/final/m101_corrected.fits
